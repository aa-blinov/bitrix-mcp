...
class ContactTools:
    ...
    async def update_contact(self, contact_id: str, fields: str) -> str:
        ...
        try:
            ...
            return json.dumps({
                ...
                "message": "Contact updated successfully" if success else "Failed to update contact"
            })
    ...
    async def get_contact_fields(self) -> str:
        ...
        try:
            ...
            payload = raw_fields[0] if isinstance(raw_fields, list) and raw_fields else raw_fields or {}
